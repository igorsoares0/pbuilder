...
export const ArrowSquareOutIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
...
export const ArrowsClockwiseIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
...
export const CornersOutIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
    <polyline points="15 3 21 3 21 9" strokeLinecap="round" strokeLinejoin="round"/>
...
export const FileArchiveIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
...
export const BrainIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4">
    ...
    <path d="M17.599 6.5a3 3 0 0 0 .399-1.375" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M6.003 5.125A3 3 0 0 0 6.401 6.5" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M3.477 10.896a4 4 0 0 1 .585-.396" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M19.938 10.5a4 4 0 0 1 .585.396" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M6 18a4 4 0 0 1-1.967-.516" strokeLinecap="round" strokeLinejoin="round"/>
